 ...
 * @author     X893, http://github.com/x893/PhoenixPilot, Copyright (C) 2013
 * @addtogroup OpenPilotSystem OpenPilot System
 * @{
 * @addtogroup OpenPilotCore OpenPilot Core
 * @{
 * @brief Defines board specific static initializers for hardware for the FlyingF4x board.
 *****************************************************************************/
/* 
 ...
 * FlyingF4X board. Please see hardware/Production/FlyingF4X/pinout.txt for
 * an overview.
 */
